class LevelPart2 extends Phaser.Scene{
    ...
    /////////////////////////////
        ...
        player = this.physics.add.sprite(2530, 260, 'vinetta').setDepth(3);
        //player = this.physics.add.sprite(2020, 2232, 'vinetta').setDepth(3);
    ...
    this.anims.create({
      ...
      /////////////////////////////
        ...
        for (const coffre of  coffreObjects) {
            ...
            this.coffre.create(coffre.x, coffre.y, 'tresorBleu')
                .setOrigin(0.5,0.5)
                .setDepth(1)
                .setScale(1)
        }

        this.physics.add.overlap(player, this.coffre ,recupCoffreBleu, null,this);
